...
$fragments = [
    ...
    [$syncService, 'function run_connector_check(array $params = [])', 'Sync service should expose dry-run connector check entrypoint.'],
    ...
    [$admin, "case 'ksef_connector_check_now':", 'Admin runtime should handle manual KSeF connector check action.'],
    ...
    [$admin, 'function handle_ksef_connector_check_now()', 'Admin runtime should expose KSeF connector check handler.'],
    ...
    [$settingsTemplate, 'id="erp-omd-ksef-connector-check-form"', 'Settings template should include hidden form for connector test action.'],
