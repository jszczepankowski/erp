...
$clientRequestEndDateFieldCount = substr_count($runtime, "wp_unslash(\$_POST['end_date'] ?? '')");
...
if ($clientRequestEndDateFieldCount < 1) {
    throw new RuntimeException('Client project request should preserve end_date field.');
}
