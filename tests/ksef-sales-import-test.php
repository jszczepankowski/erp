...
$fragments = [
    ...
    [$template, 'name="erp_omd_action" value="bulk_ksef_cost_invoices"', 'Admin template should expose KSeF cost bulk action form.'],
    [$template, 'name="cost_invoice_ids[]"', 'Admin template should expose KSeF cost row checkboxes for bulk action.'],
    [$template, 'status_nieistotne', 'Admin template should expose "nieistotne" cost invoice status actions.'],
