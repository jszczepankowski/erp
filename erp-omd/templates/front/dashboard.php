...
<body class="erp-omd-front-body">
    ...
    <script src="<?php echo esc_url(ERP_OMD_URL . 'assets/js/front-manager.js?ver=' . ERP_OMD_VERSION); ?>"></script>
    <script>
    (function () {
        ...
        if (window.erpOmdFrontManager && typeof window.erpOmdFrontManager.setupTabs === 'function') {
        ...
        if (window.erpOmdFrontManager && typeof window.erpOmdFrontManager.setupProjectsTableFilters === 'function') {
            window.erpOmdFrontManager.setupProjectsTableFilters({
                actionHeader: '<?php echo esc_js(__('Akcja', 'erp-omd')); ?>'
            });
        }
        if (window.erpOmdFrontManager && typeof window.erpOmdFrontManager.setupManagerTimeEntryForm === 'function') {
            window.erpOmdFrontManager.setupManagerTimeEntryForm();
        }
        if (window.erpOmdFrontManager && typeof window.erpOmdFrontManager.setupApprovalQueueFilters === 'function') {
            window.erpOmdFrontManager.setupApprovalQueueFilters({
                actionsHeader: '<?php echo esc_js(__('Akcje', 'erp-omd')); ?>'
            });
        }
        ...
        if (window.erpOmdFrontManager && typeof window.erpOmdFrontManager.setupEstimateItemsForm === 'function') {
            window.erpOmdFrontManager.setupEstimateItemsForm({
                removeItemLabel: '<?php echo esc_js(__('Usuń pozycję', 'erp-omd')); ?>'
            });
        }
    })();
    </script>
