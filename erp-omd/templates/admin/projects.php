    ...
    <div class="erp-omd-card">
        ...
        <form method="post">
            ...
            <p>
                ...
                <input type="text" class="regular-text" name="source_project_ids" placeholder="12,15,19" value="<?php echo esc_attr($merge_source_project_ids); ?>" required />
            </p>
            <p>
