<div class="erp-omd-card">
    ...
    <form method="post" class="erp-omd-form-grid">
        ...
        <p><label for="erp-omd-admin-task-text"><?php esc_html_e('Treść taska', 'erp-omd'); ?></label><br><textarea id="erp-omd-admin-task-text" name="task_text" rows="3" class="large-text" required></textarea></p>
