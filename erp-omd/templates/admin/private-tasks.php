        ...
        <section class="erp-omd-card">
            ...
            <form method="post" id="erp-omd-bulk-private-tasks-form">
                ...
                <table class="widefat striped">
                    <thead><tr><td class="check-column"><input type="checkbox" class="erp-omd-select-all-task" /></td><th><?php esc_html_e('ID', 'erp-omd'); ?></th><th><?php esc_html_e('Data dodania', 'erp-omd'); ?></th><th><?php esc_html_e('Zadanie', 'erp-omd'); ?></th><th><?php esc_html_e('Termin', 'erp-omd'); ?></th><th><?php esc_html_e('Status', 'erp-omd'); ?></th><th><?php esc_html_e('Akcje', 'erp-omd'); ?></th></tr></thead>
                    <tbody>
                    <?php if (! empty($dashboard_private_tasks)) : foreach ($dashboard_private_tasks as $i => $task_row) : $task_id = (string) ($task_row['task_id'] ?? ''); ?>
                        <tr>
                            <th class="check-column"><input type="checkbox" name="task_ids[]" value="<?php echo esc_attr($task_id); ?>" /></th>
                            ...
                            <td>
                                <form method="post" class="erp-omd-inline-form">
                                    ...
                                    <input type="text" name="task_text" value="<?php echo esc_attr((string) ($task_row['text'] ?? '')); ?>" class="regular-text" />
                            </td>
                            <td><input type="date" name="task_due_date" value="<?php echo esc_attr((string) ($task_row['due_date'] ?? '')); ?>" /></td>
