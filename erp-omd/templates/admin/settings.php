<div class="wrap erp-omd-admin">
    ...
    <nav class="nav-tab-wrapper erp-omd-nav-tabs">
        <a href="<?php echo esc_url(add_query_arg(['page' => 'erp-omd-settings', 'tab' => 'fixed_costs'], admin_url('admin.php'))); ?>" class="nav-tab <?php echo $settings_tab === 'fixed_costs' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Stałe koszty miesięczne', 'erp-omd'); ?></a>
        ...
        <a href="<?php echo esc_url(add_query_arg(['page' => 'erp-omd-settings', 'tab' => 'missing_hours'], admin_url('admin.php'))); ?>" class="nav-tab <?php echo $settings_tab === 'missing_hours' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Powiadomienia o brakujących godzinach', 'erp-omd'); ?></a>
        <a href="<?php echo esc_url(add_query_arg(['page' => 'erp-omd-settings', 'tab' => 'estimate_mail_templates'], admin_url('admin.php'))); ?>" class="nav-tab <?php echo $settings_tab === 'estimate_mail_templates' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Szablony maili kosztorysów', 'erp-omd'); ?></a>
        <a href="<?php echo esc_url(add_query_arg(['page' => 'erp-omd-settings', 'tab' => 'front_login'], admin_url('admin.php'))); ?>" class="nav-tab <?php echo $settings_tab === 'front_login' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Ekran logowania FRONT', 'erp-omd'); ?></a>
        ...
        <a href="<?php echo esc_url(add_query_arg(['page' => 'erp-omd-settings', 'tab' => 'reports_v1_monitoring'], admin_url('admin.php'))); ?>" class="nav-tab <?php echo $settings_tab === 'reports_v1_monitoring' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Reports v1 — SLO i monitoring', 'erp-omd'); ?></a>
    </nav>
