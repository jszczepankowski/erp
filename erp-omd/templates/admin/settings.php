    ...
    <div class="erp-omd-card">
        ...
        <form method="post">
            ...
            <div class="erp-omd-form-sections">
                ...
                <section class="erp-omd-form-section">
                    <div class="erp-omd-form-section-header">
                        <h3><?php esc_html_e('KSeF (tryb manualny)', 'erp-omd'); ?></h3>
                        <p><?php esc_html_e('Połączenie online z KSeF zostało wyłączone. Dostępny jest manualny import XML i przypisywanie faktur.', 'erp-omd'); ?></p>
                    </div>
                    <div class="erp-omd-form-grid">
                        <div class="erp-omd-form-field erp-omd-form-field-span-2">
                            <label class="erp-omd-form-label">
