 ...
 * Description: ERP_OMD V2 Sprint 2 foundation: employees, roles, salary history, clients, client rates, projects, admin UI, and REST API.
 * Version: 0.2.0
 * Author: OpenAI
 * Text Domain: erp-omd
 */
...
define('ERP_OMD_VERSION', '0.2.0');
define('ERP_OMD_DB_VERSION', '2.0.0');
