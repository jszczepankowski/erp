 ...
 * Description: ERP_OMD V2 Sprint 1 foundation: employees, roles, salary history, admin UI, and REST API.
 * Version: 0.1.0
 * Author: OpenAI
 * Text Domain: erp-omd
 */
...
define('ERP_OMD_VERSION', '0.1.0');
define('ERP_OMD_DB_VERSION', '1.0.0');
