...
class ERP_OMD_Admin
{
    ...
    public function register_menu()
    {
        ...
        add_submenu_page('erp-omd', __('Finanse', 'erp-omd'), __('Finanse', 'erp-omd'), 'erp_omd_access', 'erp-omd-finances', [$this, 'render_finances_page']);
    ...
    public function render_finances_page()
    {
        ...
        $top_projects_best = $this->build_profit_ranking($projects_report, 'project_name');
        $top_projects_worst = $this->build_profit_ranking($projects_report, 'project_name', false);
        $top_clients_best = $this->build_profit_ranking($clients_report, 'client_name');
        $top_clients_worst = $this->build_profit_ranking($clients_report, 'client_name', false);
    ...
    private function build_profit_ranking(array $rows, $name_key, $best = true)
    {
        $normalized = [];
        foreach ($rows as $row) {
            $normalized[] = [
