...
class ERP_OMD_Admin
{
    ...
    public function render_projects()
    {
        ...
        $projects_calendar_cursor = DateTimeImmutable::createFromFormat('Y-m-d', $projects_calendar_month . '-01') ?: new DateTimeImmutable($projects_calendar_month . '-01');
        $projects_calendar_month_start = $projects_calendar_cursor->setTime(0, 0);
        $projects_calendar_month_end = $projects_calendar_month_start->modify('last day of this month');
        $projects_calendar_grid_start = $projects_calendar_month_start->modify('-' . ((int) $projects_calendar_month_start->format('N') - 1) . ' days');
        ...
        $projects_seen_for_calendar = [];
        $sync_repository = class_exists('ERP_OMD_Project_Calendar_Sync_Repository')
        ...
        foreach ($projects as $project_row) {
            ...
            if (! isset($projects_seen_for_calendar[$project_id])) {
                $projects_seen_for_calendar[$project_id] = true;
        ...
        $projects_calendar_data = [
            ...
            'weeks' => $projects_calendar_weeks,
            'totals' => $projects_calendar_totals,
        ];
