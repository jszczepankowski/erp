<div class="wrap erp-omd-admin">
    ...
    <div class="erp-omd-card">
        ...
        <form method="post" id="erp-omd-bulk-projects-form">
            ...
            <div class="tablenav top"><div class="alignleft actions"><select name="bulk_action"><option value=""><?php esc_html_e('Akcje masowe', 'erp-omd'); ?></option><option value="activate"><?php esc_html_e('Aktywuj', 'erp-omd'); ?></option><option value="deactivate"><?php esc_html_e('Dezaktywuj', 'erp-omd'); ?></option><?php foreach (['do_rozpoczecia', 'w_realizacji', 'w_akceptacji', 'do_faktury', 'zakonczony', 'inactive'] as $project_status_bulk) : ?><option value="<?php echo esc_attr('set_status:' . $project_status_bulk); ?>"><?php echo esc_html(sprintf(__('Ustaw status: %s', 'erp-omd'), $this->project_status_label($project_status_bulk))); ?></option><?php endforeach; ?></select><button class="button action" type="submit"><?php esc_html_e('Zastosuj', 'erp-omd'); ?></button></div></div>
        </form>
        <table class="widefat striped">
