...
- **Bieżący krok:** `WB-P5-HF-19` (stabilizacja/hotfix) — podgląd `dashboard-v1` ma dodatkową linię debug (kod błędu fetch/localStorage) ułatwiającą diagnozę, gdy widok nie ładuje danych live.
