...
- **Bieżący krok:** `WB-P5-HF-13` (stabilizacja/hotfix) — `data_health` rozszerzone o liczniki źródeł danych, a UI pokazuje diagnostyczny komunikat „dlaczego pusto” (trend/projekty/klienci/kolejka/korekty).
