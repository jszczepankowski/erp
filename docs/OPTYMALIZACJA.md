...
- **Postęp bloku 1) OPTYMALIZACJA:**
  ...
  - **T2.1:** W TRAKCIE (wydzielenie wspólnego helpera front JS `dedupeProjectRequestDateFields` do `assets/js/front-shared.js` + wyniesienie logiki tabs do dedykowanych assetów `assets/js/front-manager.js` i `assets/js/front-worker.js`; kolejne kroki: wynoszenie tables/collapsible do tych samych assetów).
